...
def blastn(blast_data: BlastData):
    ...
    blastn_cline = NcbiblastnCommandline(query= "temp.fa", db=blast_data.database, evalue=blast_data.expect_threshold, outfmt=5, word_size = blast_data.word_length, num_alignments = blast_data.max_alignments)
